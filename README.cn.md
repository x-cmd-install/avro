...
- **Star**: 3,305 · **Fork**: 1,772 · **开放 issue**: 0 · **贡献者**: 430

## 累计统计

- **发布数**: 23 · **已合并 PR**: 2910 · **开放 PR**: 233 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 5100
...
在 [repology.org](https://repology.org/project/avro) 上共有 **209** 个发行版报告此项目。**14** 个 ✅ 已是最新上游版本，**190** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T20:51:20Z._
